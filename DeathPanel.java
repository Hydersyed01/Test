...
public class DeathPanel extends JPanel 
{
   ...
   public DeathPanel(JFrame frame) 
   {
      ...
      myBuffer.drawString("You Lost!!",130,225);
      ...
      reButton = new JButton ("Play Again");
      reButton.setFont(new Font("Times New Roman", Font.BOLD, 50));
      ...
      homeButton.setFont(new Font("Times New Roman", Font.BOLD, 50));
